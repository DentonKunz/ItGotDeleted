...
if(global.sectionNext == 1)
{
	...
	if(section==2){
		...
		instance_create_layer(1520,850,"Instances",obj_wall);
	}
	
	if(section==3){
		instance_create_layer(1200,180,"Instances",obj_wall2);
		instance_create_layer(1264,180,"Instances",obj_wall);
		instance_create_layer(1520,560,"Instances",obj_wall);
	}
